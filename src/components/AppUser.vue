<template>
    <section class="zyw-container">
        <div class="home-head white-bgcolor clearfix">
            <div class="head-img">
                <div class="head-logo"><img src="../assets/img/mylogo.png" alt=""></div>
                <div class="head-name">{{data.data.username}}<span @click="logout">注销</span></div>
                <div class="head-icon">
...
export default {
    ...
    methods:{
        logout(){
            axios({
                url:'http://47.102.210.231/api/logout'
            }).then(res=>{
                console.log(res)
